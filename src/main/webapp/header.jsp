...
<body>
<div class="n-header-container jsNHeaderCont">
            <div class="n-header__inner clearfix relative">
                <span class="n-header__aside-btn jsAsideBtn">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="13.5" viewBox="0 0 14 13.5">
                        <g id="hamburger" transform="translate(-15.5 -94.75)">
                            <path id="선_107" d="M14 0L0 0" class="hamburger-bars" transform="translate(15.5 95.5)"></path>
                            <path id="선_108" d="M14 0L0 0" class="hamburger-bars" transform="translate(15.5 101.5)"></path>
                            <path id="선_109" d="M14 0L0 0" class="hamburger-bars" transform="translate(15.5 107.5)"></path>
                        </g>
                    </svg>
                </span>
                <h1 class="n-header__logo n-header__logo--center testkjh" aria-label="tamburins">
                    <a href="showProducts.jsp" title="tamburins">
                        <!-- <svg class="logo-svg logo-svg--white" xmlns="http://www.w3.org/2000/svg" width="197.655" height="33.262" viewBox="0 0 197.655 33.262">
                            <g>
                ...
                <div class="n-header__nav text-center clearfix">
                    <nav class="n-nav">
                        <ul class="n-nav__list float-left font--13 font--md inline n-header__pc">
                            <li class="n-nav__item"><a class="n-nav__link" href="https://www.tamburins.com/shop/list.php?ca_id=20&amp;sub_ca_id=2092">향 관련 제품</a>
                            </li>
                                                        <li class="n-nav__item"><a class="n-nav__link color--red" href="https://www.tamburins.com/shop/list.php?ca_id=20&amp;sub_ca_id=2080">선물 추천</a></li>
                            <li class="n-nav__item"><a class="n-nav__link" href="https://www.tamburins.com/shop/list.php?ca_id=20&amp;sub_ca_id=2070">샘플 경험</a></li>
                                                        <!-- <li class="n-nav__item"><a class="n-nav__link"
                                    href="https://www.tamburins.com/shop/list.php?ca_id=20&sub_ca_id=2091">스킨 케어</a>
                            </li> -->
                            <li class="n-nav__item"><a class="n-nav__link" href="https://www.tamburins.com/store/">매장 보기</a></li>
                        </ul>

                        
                        <ul class="n-nav__list float-right font--13 font--md inline n-header__pc">
                            
                                                    
                            <li class="n-nav__item">
                                <select class="n-nav__select font--15" name="" id="language-mobile" onchange="location_submit(this.value)">
                                                                        <option value="selected">Shop in KR</option>
                                                                        <option value="KR">KR</option>
                                    <option value="CN">CN</option>
                                    <option value="EN">EN</option>
                                </select>
                            </li>
                                                        <li class="n-nav__item"><a class="n-nav__link" href="https://www.tamburins.com/account/order_list.php?filter=all">마이페이지</a>
                            </li>

                            

                                                        <li class="n-nav__item"><a class="n-nav__link" href="https://www.tamburins.com/bbs/login.php?url=https://www.tamburins.com/shop/list.php?ca_id=20&amp;sub_ca_id=2092">로그인</a>
                            </li>
                                                        <li class="n-nav__item n-nav__item--last">
							<a class="n-nav__link n-nav__link--cart jsCartBtn" onclick="onClickcartbtn();"><span id="inactive" class="inactive">(0)</span></a>
                            </li>
                                                    </ul>
                        <ul class="n-nav__list float-right font--13 font--md inline n-header__mo">
                            <li class="n-nav__item">
                                <a class="n-nav__link n-nav__link--cart jsCartBtn" onclick="onClickcartbtn();">
                                    <span id="inactive_m" class="inactive" data-cnt="0">(0)</span>
                                </a>
                            </li>
                        </ul>
